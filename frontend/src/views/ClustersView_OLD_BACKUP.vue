            ...
            <v-row align="center">
              ...
              <v-col cols="12" md="3">
                <v-slider
                  ...
                  :step="1"
                  thumb-label
                  :disabled="!['dbscan', 'hdbscan'].includes(params.algorithm)"
                >
                  <template #append>
                ...
                <div class="text-caption text-grey mt-n2">
                  Puntos mínimos para formar cluster (DBSCAN/HDBSCAN)
                </div>
              </v-col>
          ...
          <v-card-text class="pa-0" style="max-height: 600px; overflow-y: auto">
            ...
            >
              <v-list-item
                ...
                :class="{
                  'bg-blue-lighten-5': selectedCluster === cluster.cluster_id,
                }"
      ...
      <v-col cols="12" md="8">
        <v-card>
          ...
          <v-card-text class="pa-0" style="height: 600px; overflow: hidden">
            ...
            />
            <v-alert v-else type="info" variant="tonal" class="ma-4">
              No hay datos para visualizar. Ajusta los parámetros y aplica el
              clustering.
            </v-alert>
          </v-card-text>
        </v-card>
      ...
      <v-card v-if="selectedDocument">
        ...
        <v-card-text class="pa-4">
          <div class="mb-3">
            ...
            <v-chip
              v-if="selectedDocument.is_noise"
              color="warning"
              class="mb-2 ml-2"
            >
              Ruido
        ...
        <v-card-actions>
          ...
          <v-btn variant="text" @click="showDocDialog = false"> Cerrar </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-container>
...
const algorithmOptions = ref([
  ...
  },
  {
    label: "HDBSCAN",
    value: "hdbscan",
    description: "Hierarchical DBSCAN - Mejora de DBSCAN más robusto",
  },
  {
    label: "K-Means",
    value: "kmeans",
